...
export const Earnings: React.FC = () => {
  ...
  const walletColumns = [
    ...
    { key: "description", label: "Description", flex: 3 },
    {
      ...
      render: (val: string) => (
        <span
          className={`premium-badge ${val === "credit" ? "success" : "danger"}`}
        >
          {val}
        </span>
      ),
  ...
  const orderColumns = [
    ...
    },
    {
      ...
      flex: 2,
      render: (val: string) => (
        <span style={{ opacity: 0.7 }}>#{val.slice(-6)}</span>
      ),
    },
    {
      key: "order_total",
        ...
        <PremiumPageHeader
          ...
          rightAction={
            <div
              ...
              style={{ gap: "8px", fontSize: "0.85rem", padding: "10px 16px" }}
            >
              <Building size={16} /> Active Account{" "}
              <span
                style={{
                  width: "8px",
                  height: "8px",
                  borderRadius: "50%",
                  background: "var(--cred-success)",
                }}
              />
            </div>
          }
          ...
          <div className="cred-stat-card" style={{ padding: "40px" }}>
            <div style={{ marginBottom: "24px" }}>
              ...
              <p style={{ color: "var(--cred-text-secondary)" }}>
                Withdraw funds directly to your linked bank account instantly.
              </p>
            </div>

            <form onSubmit={handlePayoutSubmit} style={{ maxWidth: "500px" }}>
              <div
                className="neo-input-wrapper"
