...
export const MenuManager: React.FC = () => {
  ...
  return (
    <div style={{ padding: '40px', maxWidth: '1200px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '2.5rem', marginBottom: '32px' }}>Menu Catalog Manager</h1>

      <div style={{ display: 'grid', gridTemplateColumns: '1fr 340px', gap: '40px' }}>
        {/* Dishes list */}
        <div>
          <h2 style={{ fontSize: '1.8rem', marginBottom: '24px' }}>Dishes List</h2>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                ...
                >
                  <div>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '8px' }}>
                      ...
                      <h4 style={{ fontFamily: 'var(--font-cohere)', fontSize: '1.15rem' }}>{item.name}</h4>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '24px' }}>
                    <label style={{ display: 'flex', alignItems: 'center', gap: '8px', cursor: 'pointer' }}>
                      ...
                      />
                      <span style={{ fontSize: '0.9rem', fontWeight: 600 }}>Available</span>
                    </label>
            ...
            {menuItems.length === 0 && (
              <div style={{ padding: '40px', textAlign: 'center', color: 'var(--text-muted)' }}>
                No dishes found in menu catalog. Add dishes on the right to start.
              </div>
            )}
          </div>
        </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
          ...
          >
            <h3 style={{ fontFamily: 'var(--font-cohere)', fontSize: '1.1rem', marginBottom: '16px' }}>
              Add Category
            </h3>
          ...
          >
            ...
            <form onSubmit={handleAddMenuItem} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
                <label style={{ fontSize: '0.8rem', fontWeight: 600 }}>Dish Name</label>
                <input
                  type="text"
                  value={newItemName}
                  ...
                  required
                  style={{ padding: '8px 12px', borderRadius: '6px', border: '1px solid var(--glass-border)' }}
                />
              </div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
                ...
                <textarea
                  ...
                  style={{ padding: '8px 12px', borderRadius: '6px', border: '1px solid var(--glass-border)', minHeight: '60px' }}
                />
              </div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
                ...
                <select
                  ...
                  required
                  style={{ padding: '8px 12px', borderRadius: '6px', border: '1px solid var(--glass-border)', background: '#FFF' }}
                >
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                <input
                  ...
                  style={{ width: '16px', height: '16px' }}
                />
                <label htmlFor="new-item-veg" style={{ fontWeight: 600, fontSize: '0.85rem' }}>
                  Is Vegetarian 🌱
                </label>
              </div>
