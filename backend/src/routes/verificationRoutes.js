...
import { submitApplication, getMyApplication, listApplications, getApplication, updateApplicationStatus } from "../controllers/verificationController.js";
const router = Router();
...
router.patch("/applications/:id/status", authenticateJWT, updateApplicationStatus);
