...
async function updateInventory(req, res) {
    ...
    try {
        ...
        const [rows] = await db_js_1.default.query(`SELECT m.restaurant_id, r.owner_id FROM menus m 
       ...
       WHERE m.id = ?`, [menuId]);
        ...
        params.push(menuId);
        await db_js_1.default.query(`UPDATE inventory SET ${updates.join(", ")} WHERE menu_id = ?`, params);
        return res
            .status(200)
