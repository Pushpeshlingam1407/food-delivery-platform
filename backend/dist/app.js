...
const restaurantRoutes_js_1 = __importDefault(
  require("./routes/restaurantRoutes.js"),
);
const favoriteRoutes_js_1 = __importDefault(
  require("./routes/favoriteRoutes.js"),
);
